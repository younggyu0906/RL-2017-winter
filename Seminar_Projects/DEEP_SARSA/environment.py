...
class Env(tk.Tk):
    ...
    def get_state(self):
        ...
        for reward in self.rewards:
            ...
            states.append(reward_location[0] - agent_x)     # 장애물, 도착지점의 상대위치 x
            states.append(reward_location[1] - agent_y)     # 장애물, 도착지점의 상대위치 y
            if reward['reward'] < 0:
                states.append(-1)                       # 장애물 라벨
                states.append(reward['direction'])      # 장애물 속도
            else:
                states.append(1)                        # 도착지점 라벨
